...
export default function LoginPage() {
  ...
  if (authLoading) {
    return (
      <main className="flex min-h-screen flex-col bg-aldi-bg px-4">
        <div className="mx-auto flex w-full max-w-sm flex-1 flex-col pt-4">
          <header className="mb-6 w-full">
            <Link
              href="/"
              className="touch-target inline-flex items-center gap-2 rounded-lg px-1 py-2 font-medium text-aldi-blue transition-colors hover:bg-aldi-muted-light/50 -ml-1"
            >
              <span aria-hidden>←</span>
              {t("backToShoppingList")}
            </Link>
          </header>
