...
// Receipt-based operations (upsertInventoryFromReceipt, backfillFromReceipts)
// are in ./inventory-receipt.ts to stay under the 300-line limit.
export type { ReceiptItemForInventory } from "./inventory-receipt";
export { upsertInventoryFromReceipt, backfillFromReceipts } from "./inventory-receipt";
